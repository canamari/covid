...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { casess: @statistic.casess, created_at: @statistic.created_at, deaths: @statistic.deaths, state: @statistic.state, uf: @statistic.uf, updated_at: @statistic.updated_at } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { casess: @statistic.casess, created_at: @statistic.created_at, deaths: @statistic.deaths, state: @statistic.state, uf: @statistic.uf, updated_at: @statistic.updated_at } }
